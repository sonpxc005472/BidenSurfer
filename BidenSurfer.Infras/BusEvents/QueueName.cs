namespace BidenSurfer.Infras.BusEvents
{
    public static class QueueName
    {
        ...
        public static readonly string OffConfigEvent = "OffConfigEvent";
        public static readonly string AmountExpireMessage = "AmountExpireMessage";
        ...
        public static readonly string ConfigUpdateFromApiForBotRunnerMessage = "ConfigUpdateFromApiForBotRunnerMessage";
        ...
        public static readonly string ResetBotForScannerFromApiMessage = "ResetBotForScannerFromApiMessage";
        public static readonly string ResetBotForScannerFromBotRunnerMessage = "ResetBotForScannerFromBotRunnerMessage";
